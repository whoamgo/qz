...
trait UserNotify {
    public static function notifyToUser() {
        return [
            ...
            'subscribedPlanUser'     => 'Subscribed Users',
            'notSubscribedPlanUser'  => 'Not Subscribed Users',
        ];
    }
    ...
    public function scopeSubscribedPlanUser($query) {
        return $query->whereHas('subscriptions', function ($q) {
            $q->where('status', Status::PAYMENT_SUCCESS);
        });
    }
    public function scopeNotSubscribedPlanUser($query) {
