    ...
    ->withRouting(
        ...
        using:function(){
            ...
            Route::namespace('App\Http\Controllers')->middleware($appMiddleware)->group(function(){
                ...
                // Public website routes load before web.php so they win on any
                // overlapping path; web.php stays registered as the fallback.
                Route::middleware(['web','maintenance'])->group(base_path('routes/website.php'));
