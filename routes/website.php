...
Route::namespace('Website')->name('website.')->group(function () {
    ...
    // --------------------------------------------------- daily spin & win
    // status is public (guest-aware, leaks nothing); spinning and answering
    // require auth so eligibility, result and XP are always server-decided.
    Route::controller('DailySpinController')->prefix('daily-spin')->name('daily-spin.')->group(function () {
