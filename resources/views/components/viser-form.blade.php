@props(['class' => 'form-group', 'label' => 'form-label', 'formClass' => 'form-control form--control'])
<div class="row">
    @foreach ($formData as $data)
        <div class="col-md-{{ isset($data->width) && $data->width ? $data->width : '12' }}">
            <div class="{{ $class }}">
                <label class="{{ $label }}">{{ __($data->name) }} @if (isset($data->instruction) && $data->instruction)
