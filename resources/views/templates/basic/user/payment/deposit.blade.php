    ...
    <div class="my-120">
        <div class="container ">
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    <form action="{{ route('user.deposit.insert') }}" method="post" class="card custom--card deposit-form">
                        @csrf
                        <input type="hidden" name="currency">
                        <div class="card-body p-0 gateway-card">
                            <div class="row justify-content-center gx-0 gy-3">
                                <div class="col-lg-6">
                                    <div class="payment-system-list is-scrollable gateway-option-list py-0">
                                ...
                                <div class="col-lg-6">
                                    <div class="payment-system-list payment-info-list p-3">
                                        <div class="deposit-info">
                                            <div class="deposit-info__title">
                                                <p class="text mb-0 fw-semibold">@lang('Amount')</p>
                                            </div>
                                            <div class="deposit-info__input">
                                                <p class="text has-icon fw-semibold">{{ getAmount($amount) }}
                                                    <span>{{ gs('cur_text') }}</span>
                                                </p>
                                            </div>
                                        </div>
                                        <input type="hidden" class="form-control form--control amount" name="amount"
                                               placeholder="@lang('00.00')" value="{{ getAmount($amount) }}" autocomplete="off">
                                        ...
                                        <div class="deposit-info total-amount pt-3">
                                            <div class="deposit-info__title">
                                                <p class="text fw-semibold text-white">@lang('Total')</p>
                                            </div>
                                            <div class="deposit-info__input">
                                                <p class="text fw-semibold text-white"><span class="final-amount">@lang('0.00')</span>
                                                    {{ __(gs('cur_text')) }}</p>
                                            </div>
                                        </div>
