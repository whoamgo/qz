                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control form--control md-style" name="name" value="{{ old('name') }}" required autocomplete="off" autofocus />
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="tel" class="form-control form--control md-style" name="cardNumber" autocomplete="off" value="{{ old('cardNumber') }}" required autofocus />
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="tel" class="form--control md-style" name="cardExpiry" value="{{ old('cardExpiry') }}" autocomplete="off" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6 ">
                                        <div class="form-group">
                                            <label class="form--label">@lang('CVC Code')</label>
                                            <input type="tel" class="form--control md-style" name="cardCVC" value="{{ old('cardCVC') }}" autocomplete="off" required />
                                        </div>
                                    </div>
                                </div>
