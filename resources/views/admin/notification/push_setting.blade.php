                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('API Key')" name="apiKey" value="{{ isset(gs('firebase_config')->apiKey) ? gs('firebase_config')->apiKey : '' }}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>@lang('Auth Domain') </label>
                                    <input type="text" class="form-control" placeholder="@lang('Auth Domain')" name="authDomain" value="{{ isset(gs('firebase_config')->authDomain) ? gs('firebase_config')->authDomain : '' }}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>@lang('Project Id') </label>
                                    <input type="text" class="form-control" placeholder="@lang('Project Id')" name="projectId" value="{{ isset(gs('firebase_config')->projectId) ? gs('firebase_config')->projectId : '' }}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>@lang('Storage Bucket') </label>
                                    <input type="text" class="form-control" placeholder="@lang('Storage Bucket')" name="storageBucket" value="{{ isset(gs('firebase_config')->storageBucket) ? gs('firebase_config')->storageBucket : '' }}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>@lang('Messaging Sender Id') </label>
                                    <input type="text" class="form-control" placeholder="@lang('Messaging Sender Id')" name="messagingSenderId" value="{{ isset(gs('firebase_config')->messagingSenderId) ? gs('firebase_config')->messagingSenderId : '' }}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>@lang('App Id') </label>
                                    <input type="text" class="form-control" placeholder="@lang('App Id')" name="appId" value="{{ isset(gs('firebase_config')->appId) ? gs('firebase_config')->appId : '' }}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>@lang('Measurement Id') </label>
                                    <input type="text" class="form-control" placeholder="@lang('Measurement Id')" name="measurementId" value="{{ isset(gs('firebase_config')->measurementId) ? gs('firebase_config')->measurementId : '' }}" required>
                                </div>
                            </div>
                        </div>
