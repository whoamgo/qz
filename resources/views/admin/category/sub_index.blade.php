                ...
                <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="meta_title" type="text" maxlength="255" value="{{ old('meta_title') }}" placeholder="@lang('e.g. Indian History Quiz - MCQs & Practice | Quiz Mitra')">
                            <small class="text--muted">@lang('Leave empty to auto-generate from the sub-category name.')</small>
                        </div>
                        <div class="form-group">
