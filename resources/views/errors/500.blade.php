        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-8 text-center">
                    ...
                    <h2 class="title text-white"> @lang('Sorry! Internal server error')</h2>
                    <p class="description text-white">@lang('Something went wrong on our end. We\'re working on fixing it.')</p>
