        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-7 text-center">
                    ...
                    <h2 class="title text-white"> @lang('Page not found')</h2>
                    <p class="description text-white">@lang('page you are looking for doesn\'t exist or an other error ocurred') <br> @lang('or temporarily unavailable.')</p>
