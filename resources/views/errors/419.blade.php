        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-7 text-center">
                    ...
                    <h2 class="title text-white"> @lang('Sorry! Your session has expired')</h2>
                    <p class="description text-white">@lang('Please go back and refresh your browser and try again')</p>
