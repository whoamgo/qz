...
<a href="{{ locale_route('website.subcategory.show', [$parentSlug, $topic->slug]) }}" class="w-card text-decoration-none">
    <div class="w-card-body">
        <div class="d-flex align-items-start gap-3">
            ...
            <div class="flex-grow-1">
                <h3 class="w-card-title mb-1" style="font-size: var(--w-fs-base);">{{ $topic->tr('name') }}</h3>
                <div class="w-meta">
