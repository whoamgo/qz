...
<a href="{{ locale_route('website.exam.show', $exam->slug) }}" class="w-card text-decoration-none">
    <div class="w-card-body">
        <div class="d-flex align-items-center gap-3 mb-3">
            ...
            <div>
                <h3 class="w-card-title mb-0" style="font-size: var(--w-fs-lg);">{{ $exam->tr('name') }}</h3>
